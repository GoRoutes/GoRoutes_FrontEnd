...
const PassengerAddress = computed(() => {
  return passengersStore.state.selectedPassenger.passenger_data.address || []
})

const currentAddress = computed(() => {
  return PassengerAddress.value[currentAddressIndex.value] || {}
})

function nextAddress() {
  if (currentAddressIndex.value < PassengerAddress.value.length - 1) {
...
<template>
  <section>
    <div class="addresses-container">
      <div v-if="PassengerAddress.length === 0" class="no-addresses-container">
        ...
        <v-card class="address-card" elevation="2">
          ...
          <v-card-actions class="card-actions">
            ...
            <v-btn 
              ...
              variant="outlined" 
              color="primary" 
              :disabled="currentAddressIndex === PassengerAddress.length - 1"
